...
parser.add_argument('--data_path', type=str,
                    default='../data_prompt/code_level/*.json',
                    help="Location of sample txt files.")
parser.add_argument('--output_file', type=str,
                    default='../data_prompt_mindrecord_code_thu_code_level/code/transfered_mindrecord',
...
if __name__ == '__main__':
    ...
    if args.dataset_type == 'openwebtext':
        ...
        mindrecord_filenames = [f'{args.output_file}_{str(i+1)}.mindrecord' for i in range(subprocess_number)]
    ...
    # 合并并重洗mindreocrd文件
#     data_path = "/home/ma-user/work/notebook_code/data_prompt_mindrecord_code_thu_code_level/code/"
...
#     dataset.save('/home/ma-user/work/notebook_code/data_prompt_mindrecord_code_thu_code_level/code/all_instruction.mindrecord', num_files=1)
